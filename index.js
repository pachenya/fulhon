...
function clicked() {
  if (count < xyzzy.length) {
    ...
    switch(count) {
      default:
        if (exflg2!=1 && randint0(16) == 0) {
          Msg("<span style='color: gold;'>本のタイトルをクリックすると本を開くことができるらしい……</span>");
        } else {
          Msg(randText());
        }
      break;
